...
const CertficateLanding: React.FC = () => {
            ...
            <div style={style.container} className='h-[50vh] lg:min-h-[100vh]'>
                <div className="h-[50vh] lg:min-h-screen flex flex-col w-full items-center justify-center">
                    ...
                    <div className="relative w-full flex flex-col justify-center items-center">
                        ...
                        <h1 className={`z-20 text-black text-6xl lg:text-[120px] ${styles.fred} ${styles.anim2}`}>CertficateStash</h1>
                    </div>
                    </div>
                </div>
...
export default CertficateLanding;
