        ...
        <>
            <div className="mt-8 flex flex-col items-center justify-start pb-20">
                ...
                <div className="flex flex-col lg:flex-row w-full justify-around items-center mt-8 text-justify">
                    ...
                    <div className={`text-black text-3xl w-[90%] lg:w-1/2 ${styles.indi}`}>
                        <p className={`text-3xl leading-[3.5rem] ${styles.indi}`}><b className={`${styles.pang} ${styles.anim1}`}>Welcome</b> to the whimsical world of code conjuring!</p>  <br />
