        ...
        <>
            <div className="mt-8 flex flex-col items-center justify-start pb-20 px-[20px] lg:px-[60px]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-16 lg:gap-4 mt-12 cursor-pointer transition-all">
                    ...
                    <a href={'https://github.com/Anshika75/WebMindz'} className="relative flex flex-col items-start justify-start w-full px-4 py-4 shadow-md border-4 border-black rounded-lg group hover:-translate-y-5 transition-all" target='blank'>
                        ...
                        <div className='flex text-black w-full justify-between mt-3'>
                            ...
                            <a href="https://github.com/Anshika75/WebMindz" className={`text-black text-right font-black text-lg ${styles.pang} underline ${styles.anim1}`}>Get Glimpse</a>
                        </div>
                    ...
                    <a href={'https://github.com/Anshika75/Maggi-Album?tab=readme-ov-file'} className="relative flex flex-col items-start justify-start w-full px-4 py-4 shadow-md border-4 border-black rounded-lg group hover:-translate-y-5 transition-all" target='blank'>
                        ...
                        <div className='flex text-black w-full justify-between mt-3'>
                            <i className={`${styles.pang}`}>#advance</i>
                            <a href="https://github.com/Anshika75/Maggi-Album?tab=readme-ov-file" className={`text-black text-right font-black text-lg ${styles.pang} underline ${styles.anim1}`}>Get Glimpse</a>
                        </div>
                        <div className="absolute top-0 translate-y-[-85%] left-[30%] h-10 w-6 bg-[#555] origin-bottom rotate-[5deg]"></div>
                        <div className="absolute top-0 translate-y-[-80%] left-[30%] h-10 w-6 bg-black"></div>
                        <div className="absolute top-0 translate-y-[-85%] right-[30%] h-10 w-6 bg-[#555] origin-bottom rotate-[5deg]"></div>
                    ...
                    <a href={'https://github.com/Anshika75/Maggi-Weather'} className="relative flex flex-col items-start justify-start w-full px-4 py-4 shadow-md border-4 border-black rounded-lg group hover:-translate-y-5 transition-all" target='blank'>
                        ...
                        <div className='flex text-black w-full justify-between mt-3'>
                            <i className={`${styles.pang}`}>#advance</i>
                            <a href="https://github.com/Anshika75/Maggi-Weather" className={`text-black text-right font-black text-lg ${styles.pang} underline ${styles.anim1}`}>Get Glimpse</a>
                        </div>
                        <div className="absolute top-0 translate-y-[-85%] left-[30%] h-10 w-6 bg-[#555] origin-bottom rotate-[5deg]"></div>
                        <div className="absolute top-0 translate-y-[-80%] left-[30%] h-10 w-6 bg-black"></div>
                        <div className="absolute top-0 translate-y-[-85%] right-[30%] h-10 w-6 bg-[#555] origin-bottom rotate-[5deg]"></div>
                    ...
                    <a href={'https://github.com/Anshika75/Maggi-Hub'} className="relative flex flex-col items-start justify-start w-full px-4 py-4 shadow-md border-4 border-black rounded-lg group hover:-translate-y-5 transition-all" target='blank'>
                        ...
                        <div className='flex text-black w-full justify-between mt-3'>
                            <i className={`${styles.pang}`}>#advance</i>
                            <a href="https://github.com/Anshika75/Maggi-Hub" className={`text-black text-right font-black text-lg ${styles.pang} underline ${styles.anim1}`}>Get Glimpse</a>
                        </div>
                        <div className="absolute top-0 translate-y-[-85%] left-[30%] h-10 w-6 bg-[#555] origin-bottom rotate-[5deg]"></div>
                        <div className="absolute top-0 translate-y-[-80%] left-[30%] h-10 w-6 bg-black"></div>
                        <div className="absolute top-0 translate-y-[-85%] right-[30%] h-10 w-6 bg-[#555] origin-bottom rotate-[5deg]"></div>
