    ...
    return (
        <main className={`p-[20px] lg:p-[50px] ${styles.bg}`}>
            ...
            <div className="flex flex-col items-center z-20">
                <div className={styles.head}><p className='text-[25px] lg:text-[90px] opacity-75'>Enter the Enclave</p></div>
                <h2 className={styles.sub}><p className='text-[15px] lg:text-[35px] lg:-mt-[20px] opacity-75'>Plunge into Creative Realms</p></h2>
                <div className='grid grid-cols-1 lg:grid-cols-4 gap-12 place-items-center mt-12 px-4'>
                    {themes.map((theme) => (
                        <Link href={theme.url} className='text-center'>
                            <div className="box transition-all hover:scale-110 flex flex-col items-center pb-5 px-5 bg-[#3335] shadow-[0_0px_60px_-10px_rgba(51,51,51,1)] border-[2px] border-[#3335] rounded-xl">
                                ...
                                <p key={theme.id} className={`flex flex-col opacity-75 items-center ${styles.sub} text-[20px]`}>
                                    {theme.name}
                                </p>
